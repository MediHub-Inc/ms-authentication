...
import { IsString, IsEmail, IsUUID, IsUrl, Matches, MinLength, MaxLength, IsOptional, Equals, IsEnum } from 'class-validator';
...
export class SignUpDto {
  ...
  @IsEnum(UserStatus, { message: 'Status must be either ACTIVE, DISABLED, or ARCHIVED' })
  status: UserStatus;
